...
const calculateH2 = document.getElementsByClassName('calculateH2');
const calculateButton = document.getElementsByClassName('calculateButton');
console.log(calculateH2)
...
const App = () => {
  ...
  const onMetalChange = (newMetalValue) => {
    ...
    calculateH2.style.display = 'none';
  };
  ...
  const onCount = () => {
    ...
    calculateH2.style.display = 'block';
  };
      ...
      <div className="calculator">
        ...
        <div className="content">
          ...
          <div className="calculate">
            ...
            <button className="calculateButton" onClick={onCount} disabled={disable}>
              Рассчитать
            </button>
          </div>
        </div>
