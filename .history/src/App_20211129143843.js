...
const App = () => {
  ...
  useEffect(() => {
    if(fineness.value.value > 0 && payment.value.length > 0 && gramms > 0) {
      setDisable(false)
    } else {
      setDisable(true)
    }
  }, [fineness, payment, gramms]);
      ...
      <div className="calculator">
        ...
        <div className="content">
          ...
          <div className="calculate">
            ...
            <button disabled={disable} className="calculateButton" onClick={onCount} disabled={disable}>
              Рассчитать
            </button>
          </div>
        </div>
