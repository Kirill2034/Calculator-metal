      ...
      <div className="calculator">
        ...
        <div className="content">
          ...
          <div className="select-prop-metal">
            ...
            <Select className="select" options={metals.forEach((metal) => metal.title)} placeholder="Проба металла"/>
            <Select className="select" options={metals.forEach((metal) => metal.title)} placeholder="Способ выплаты"/>
