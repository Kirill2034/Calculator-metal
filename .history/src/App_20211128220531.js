...
const calculateItems = document.getElementsByClassName('calculate').children;
const calculateButton = document.getElementsByClassName('calculate').get;
      ...
      <div className="calculator">
        ...
        <div className="content">
          ...
          <div className="calculate">
            <h2>Итого:{sum}</h2>
            <button onClick={onCount} disabled={disable}>
              Рассчитать
            </button>
          </div>
        </div>
